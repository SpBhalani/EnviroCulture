  ...
  return (
    <div id="infrastructure" className="">
        ...
        <div className='mx-1 md:mx-20 p-4'>
          <h1 className='text-3xl font-bold text-center text-white'>Clients</h1>
          <h2 className='text-xl font-light text-center text-white'>Trust the reviews and see what our clients say about us.</h2>
        </div>
      </div>

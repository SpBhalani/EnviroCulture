...
() {
  return (
    <div>
      <Head>
        <title>Enviro Culture | EIA Studies</title>
        <meta name="description" content="We guide our clients to get legal approvals from the authorities that are responsible for levying restrictions and prohibitions to save the environment from pollutions toxic wastes."></meta>
      </Head>

...
() {
  return (
    <div>
      <Head>
        <title>Enviro Culture | Waste Management</title>
        <meta name="description" content="Enviro culture provides waste management services to ensure proper handling and disposal of the waste from your project in a cost-effective manner."></meta>
      </Head>
